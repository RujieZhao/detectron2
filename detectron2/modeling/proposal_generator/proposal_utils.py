...
def add_ground_truth_to_proposals_single_image(
    ...
    """
    # print("add_gt:",proposals.get_fields().keys())#['proposal_boxes', 'objectness_logits']
    if isinstance(gt, Boxes):
        # convert Boxes to Instances
        gt = Instances(proposals.image_size, gt_boxes=gt)
    # print("gt_field:",gt.get_fields().keys())#['gt_boxes', 'gt_classes', 'gt_masks']
    ...
    # print("gt_fields:",gt.get_fields().keys())#['gt_boxes', 'gt_classes', 'gt_masks']
    gt_proposal = Instances(proposals.image_size, **gt.get_fields())
    gt_proposal.proposal_boxes = gt_boxes
    gt_proposal.objectness_logits = gt_logits
    # print(gt_proposal.get_fields().keys()) #(['gt_boxes', 'gt_classes', 'gt_masks', 'proposal_boxes', 'objectness_logits']
    for key in proposals.get_fields().keys():
        # print(key) #proposal_boxes objectness_logits
    ...
    # will be thrown away.
    new_proposals = Instances.cat([proposals, gt_proposal]) #['proposal_boxes', 'objectness_logits']
    # print(new_proposals.get_fields().keys())
